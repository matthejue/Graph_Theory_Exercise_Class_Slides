...
\newcommand{\titlesecond}{Exercise class 4}
\newcommand{\subtitlesecond}{Maximum Matching, Maximal Matching, Perfect Matching, Vertex Cover, Independant Set, Edge Cover, Hungarian Algorithm}
\newcommand{\groups}{
\if\matthias0{
Groups 2, 4
}\else{
