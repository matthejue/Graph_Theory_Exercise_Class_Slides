...
% https://tex.stackexchange.com/questions/130327/how-do-i-access-floats-name-e-g-for-use-with-caption
% \renewcommand{\algorithmname}{\color{SecondaryColor}Algorithm}
% \floatname{algorithm}{\color{SecondaryColor}Algorithm}
% \makeatletter
% \let\algorithmname\fname@algorithm
% \makeatother
\setbeamercolor{caption name}{fg=SecondaryColor}
\setbeamercolor{caption}{fg=black}

\renewcommand{\pseudohl}{\rowcolor{SecondaryColorDimmed}}

% ┌─────────────────────────┐
% │ Titlepage Configuration │
% └─────────────────────────┘

\newcommand{\titlesecond}{Exercise class 5}
\newcommand{\subtitlesecond}{\small Maximum-Flow and Minimum-Cut, Graph Coloring, Cliques, Independant Sets, Maximum Matching, Minimum Vertex Cover, Maximum Indepedant Set, Minimum Edge Cover}
\newcommand{\groups}{
\if\matthias0{
Groups 2, 4
}\else{
...
(\href{mailto://herrmanm@informatik.uni-freiburg.de}{herrmanm@informatik.uni-freiburg.de})
}\fi
}
...
\begin{columns}[t]
  ...
  \begin{column}{0.5\textwidth}
    \raggedleft
    \small
    \emph{Supervisor for the exercises:}
...
\newcommand{\lehrstuhl}{Chair of Computer Networks and Telematics}
...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    ...
    \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
      \usebeamerfont{title in head/foot}\titlesecond,\enspace\groups
    \end{beamercolorbox}%
