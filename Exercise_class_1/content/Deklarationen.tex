...
\begin{block}#2{Task \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}}{\end{block}\stepcounter{task}}

% https://tex.stackexchange.com/questions/152565/define-a-new-block-environment-in-latex-beamer
\renewenvironment<>{tasknoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Task \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}}{\end{block}}

\newenvironment<>{requirements}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Requirements \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}\itshape}{\end{block}\stepcounter{task}}

\newenvironment<>{requirementsnoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Requirements \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}\itshape}{\end{block}}

\newenvironment<>{solution}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=PrimaryColor}%
\begin{block}#2{Solution \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}\itshape}{\end{block}\stepcounter{task}}

\newenvironment<>{solutionnoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=PrimaryColor}%
\begin{block}#2{Solution \thesection{.}\thetask\enspace\ignorespaces #1 \magnifier}\itshape}{\end{block}}
