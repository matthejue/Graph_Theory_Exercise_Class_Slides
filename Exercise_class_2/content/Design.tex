...
\newcommand{\titlesecond}{Exercise class 2}
\newcommand{\subtitlesecond}{Directed Graphs, Connectivity, Trails, Circuits, Representations of directed graphs, Eulerian Trails and Circuits, Trees and Kruskal}
\newcommand{\groups}{
\if\matthias0{
Groups 2, 4
}\else{
