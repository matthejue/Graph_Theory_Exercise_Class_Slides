...
\renewenvironment<>{exercisenoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Exercise \thesection{.}\theexercise\enspace\ignorespaces #1 \anotebook}}{\end{block}}
...
\begin{block}#2{Solution \thesection{.}\theexercise\enspace\ignorespaces #1 \notebook}\itshape}{\end{block}\stepcounter{exercise}}
