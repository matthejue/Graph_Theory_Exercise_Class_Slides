...
\begin{frame}[allowframebreaks]{Exercise \thesection}{Necessary and Sufficient}
  \begin{itemize}
  ...
  \begin{Sidenote}
    \begin{itemize}
      \item if $A\rightarrow B$ then for $A$ we only know for sure $\neg B\rightarrow \neg A$, for $\neg A$ it can both be the case that $\neg A\rightarrow B$ or $\neg A\rightarrow \neg B$,
