...
\begin{block}#2{Exercise \thesection{.}\theexercise\enspace\ignorespaces #1 \anotebook}}{\end{block}\stepcounter{exercise}}

% https://tex.stackexchange.com/questions/152565/define-a-new-block-environment-in-latex-beamer
\renewenvironment<>{exercisenoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{
Exercise \thesection{.}\theexercise\enspace\ignorespaces #1 \anotebook}}{\end{block}}

\newenvironment<>{requirements}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Requirements \thesection{.}\theexercise\enspace\ignorespaces #1 \anotebook}\itshape}{\end{block}\stepcounter{exercise}}

\newenvironment<>{requirementsnoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColor}%
\begin{block}#2{Requirements \thesection{.}\theexercise\enspace\ignorespaces #1 \anotebook}\itshape}{\end{block}}
...
\newenvironment<>{definition}[1]{%
  \setbeamercolor{block title}{fg=white,bg=SecondaryColorDimmed}%
\begin{block}#2{Definition \thedefinition\enspace\ignorespaces #1 \anotebook}\itshape}{\end{block}\stepcounter{definition}}
...
% \renewcommand{\pr}[1]{{\textnormal{\textsc{#1}}}}
...
\newcommand{\annotation}[2]{\path (#1) -- node[annotation, above, align=center, pos=0.05] {#2} (sa);}
